...
import { Route as StitchRouteImport } from './routes/stitch'
...
const StitchRoute = StitchRouteImport.update({
  id: '/stitch',
  path: '/stitch',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  StitchRoute: typeof StitchRoute
}
