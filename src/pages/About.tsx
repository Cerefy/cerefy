      ...
      <section className="relative h-[819px] flex items-center justify-center overflow-hidden px-margin-desktop">
        <div className="relative z-10 text-center max-w-4xl">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="font-mono-data text-mono-data text-secondary-fixed-dim tracking-[0.2em] uppercase">
              Status: Core Active
            </span>
          </div>
          <h1 className="font-display-lg text-display-lg text-primary mb-8 tracking-tighter">
            Advanced Optical Intelligence
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-10">
            Precision-engineered vision systems designed for the next era of high-performance
            automation, healthcare, and navigation.
          </p>
          <div className="flex gap-4 justify-center">
            <button className="px-8 py-4 bg-primary text-background font-label-caps text-label-caps rounded-lg hover:bg-secondary-fixed-dim transition-all glow-cyan uppercase">
              Deploy Module
            </button>
            <button className="px-8 py-4 border border-outline-variant text-primary font-label-caps text-label-caps rounded-lg hover:bg-white/5 transition-all uppercase">
              View SDK
            </button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-gutter items-center">
          ...
          <div className="pl-12">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mb-8 leading-relaxed">
              Cerefy provides sub-millimeter spatial awareness for autonomous platforms. Our
              proprietary optical-flow algorithms enable high-speed processing in unpredictable
              environments, from aerial drones to terrestrial logistics fleets.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 border-b border-white/5 pb-4">
                ...
                <span className="font-body-md text-on-surface">
                  Ultra-low latency inference ( &lt; 2ms )
                </span>
              </li>
              <li className="flex items-start gap-3 border-b border-white/5 pb-4">
                <span
                ...
                <span className="font-body-md text-on-surface">
                  Adverse weather pattern compensation
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="py-24 px-margin-desktop bg-surface-container-lowest/30 border-y border-white/5">
        <div className="grid md:grid-cols-2 gap-gutter items-center">
          <div className="order-2 md:order-1 pr-12">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mb-8 leading-relaxed">
              Precision diagnostics powered by hyper-spectral vision. Our sensors identify
              micro-anomalies in tissue structures before they become clinically visible,
              integrating directly into robotic surgical suites and remote triage units.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="glass-panel border border-white/5 p-4 rounded">
                <div className="text-secondary-fixed-dim font-headline-md text-[24px] mb-1">
                  99.8%
                </div>
                <div className="text-on-surface-variant font-label-caps text-[10px] uppercase">
                  Accuracy Rate
                </div>
              </div>
              <div className="glass-panel border border-white/5 p-4 rounded">
        ...
        <div className="grid md:grid-cols-2 gap-gutter items-center">
          <div className="glass-panel rounded-xl overflow-hidden aspect-video relative group border border-white/5">
            <img
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-3O9TDZYWGe4wjXu_clAgqGFnd-a85V-xrDtY4u4Co7qvEmSDbMr74-nA6VFp5zS4RM8nKUeypBJo74XUPwlO3MqB1MWe_icIo0Y-q_u0pgXOrPUGPpJ35pjCcyJqUSCziSsKFywGmtVIJt3nWDGgXQQIjXcF2HGuFqmkqvIv4sSKa5rdgasK4rVTa2hVwLsNEPSx5LTp8eWTtDD6f5HwHBFYDUWxkPNIHYAkBVraIq2EbNX87efFEH-h09ZoIpKMvWIOPaZDtOMV"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent"></div>
            <div className="absolute bottom-6 left-6 flex items-center gap-2">
              <span
          ...
          <div className="pl-12">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mb-8 leading-relaxed">
              Scale production with machine vision that never blinks. From defect detection on
              high-speed assembly lines to collaborative robotics in smart factories, Cerefy ensures
              absolute consistency in every cycle.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-margin-mobile md:px-0">
          <div className="mb-12 text-center">
            ...
            <p className="font-body-md text-on-surface-variant">
              Three lines of code to initialize the future of optical compute.
            </p>
          </div>
          <div className="rounded-xl overflow-hidden border border-outline-variant bg-[#050505] shadow-2xl">
            <div className="flex items-center justify-between px-6 py-4 bg-[#111111] border-b border-outline-variant">
              ...
              <div className="text-on-surface-variant font-mono-data text-[12px]">
                Cerefy_main.py
              </div>
            ...
            <div className="p-8 font-mono-data text-mono-data text-[14px] leading-relaxed overflow-x-auto">
              <pre className="text-[#888]">
                <code>
                  <span className="text-secondary-fixed-dim">import</span> Cerefy_core{" "}
                  <span className="text-secondary-fixed-dim">as</span> ex
                  {"\n"}
                  <span className="text-[#555]">
                    # Initialize optical cluster with neural prioritization
                  </span>
                  cluster = ex.VisionCluster(config=
                  <span className="text-[#00eefc]">"ultra_low_latency"</span>){"\n"}
                  <span className="text-[#555]"># Deploy diagnostic module to active feed</span>
                  module = cluster.deploy(
                  <span className="text-secondary-fixed-dim">"BIO_VIS_X1"</span>){"\n"}
                  ...
                  <span className="text-[#00eefc]">
                    "Inference: {"{telemetry.accuracy}"}% | Latency: {"{telemetry.ms}"}ms"
                  </span>
                  )
                </code>
              </pre>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-primary">
                <th className="py-6 font-label-caps text-label-caps text-on-surface-variant uppercase tracking-widest">
                  Parameter
                </th>
                <th className="py-6 font-label-caps text-label-caps text-on-surface-variant uppercase tracking-widest">
                  Standard Core
