        ...
        this.props.fallback || (
          <div className="min-h-screen bg-[#08080a] flex items-center justify-center p-8">
            <div className="max-w-2xl w-full text-left">
              ...
              <h2 className="text-xl font-semibold text-white mb-2 text-center">Application Error</h2>
              <div className="bg-zinc-900 border border-zinc-700 rounded-lg p-4 mb-6 overflow-auto max-h-64">
                <p className="text-red-400 font-mono text-sm mb-2">{this.state.error?.message}</p>
                <pre className="text-zinc-400 text-xs whitespace-pre-wrap break-all">{this.state.error?.stack}</pre>
              </div>
