...
const ROUTER_PROMPT = `You are the Cerefy Agent Orchestrator. Given a user request, classify which agent should handle it.
...
Respond helpfully as the Cerefy AI Copilot. Be concise and professional.`,
      { temperature: 0.5 },
    );
